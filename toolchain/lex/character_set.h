...
#ifndef MYLANG_TOOLCHAIN_LEX_CHARACTER_SET_H_
#define MYLANG_TOOLCHAIN_LEX_CHARACTER_SET_H_
...
// Is this an alphabetical character according to MyLang's lexical rules?
//
...
// Is this a decimal digit according to MyLang's lexical rules?
//
// This currently includes '0'..'9'.
inline auto IsDecimalDigit(char c) -> bool { return llvm::isDigit(c); }

// Is this an alphanumeric character according to MyLang's lexical rules?
//
...
// Is this a hexadecimal digit according to MyLang's lexical rules?
//
...
#endif  // MYLANG_TOOLCHAIN_LEX_CHARACTER_SET_H_
