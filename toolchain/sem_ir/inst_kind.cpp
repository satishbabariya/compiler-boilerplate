...
MYLANG_DEFINE_ENUM_CLASS_NAMES(InstKind) {
#define MYLANG_SEM_IR_INST_KIND(Name) MYLANG_ENUM_CLASS_NAME_STRING(Name)
...
#define MYLANG_SEM_IR_INST_KIND(Name) SemIR::Name::Kind.info_,
#include "toolchain/sem_ir/inst_kind.def"
  };
...
#define MYLANG_SEM_IR_INST_KIND(Name) Internal::HasTypeIdMember<SemIR::Name>,
#include "toolchain/sem_ir/inst_kind.def"
  };
  return Table[AsInt()];
}
