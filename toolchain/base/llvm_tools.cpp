...
#define MYLANG_LLVM_MAIN_TOOL(Identifier, Name, BinName, MainFn)              \
...
MYLANG_DEFINE_ENUM_CLASS_NAMES(LLVMTool) {
#define MYLANG_LLVM_TOOL(Identifier, Name, BinName, MainFn) Name,
#include "toolchain/base/llvm_tools.def"
};

constexpr llvm::StringLiteral LLVMTool::BinNames[] = {
#define MYLANG_LLVM_TOOL(Identifier, Name, BinName, MainFn) BinName,
#include "toolchain/base/llvm_tools.def"
};

constexpr LLVMTool::MainFnT* LLVMTool::MainFns[] = {
#define MYLANG_LLVM_TOOL(Identifier, Name, BinName, MainFn) &::MainFn,
#include "toolchain/base/llvm_tools.def"
};
