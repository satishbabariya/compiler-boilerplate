...
#ifndef MYLANG_TOOLCHAIN_BASE_CLANG_INVOCATION_H_
#define MYLANG_TOOLCHAIN_BASE_CLANG_INVOCATION_H_
...
// Converts diagnostics from the Clang driver to MyLang diagnostics.
class ClangDriverDiagnosticConsumer : public clang::DiagnosticConsumer {
 public:
  ...
  // Generates a MyLang warning for each Clang warning and a MyLang error for
...
// MyLang-compatible Clang invocation.
//
...
#endif  // MYLANG_TOOLCHAIN_BASE_CLANG_INVOCATION_H_
