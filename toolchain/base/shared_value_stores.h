...
#ifndef MYLANG_TOOLCHAIN_BASE_SHARED_VALUE_STORES_H_
#define MYLANG_TOOLCHAIN_BASE_SHARED_VALUE_STORES_H_
...
#endif  // MYLANG_TOOLCHAIN_BASE_SHARED_VALUE_STORES_H_
