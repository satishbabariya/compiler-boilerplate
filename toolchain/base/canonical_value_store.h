...
#ifndef MYLANG_TOOLCHAIN_BASE_CANONICAL_VALUE_STORE_H_
#define MYLANG_TOOLCHAIN_BASE_CANONICAL_VALUE_STORE_H_
...
#endif  // MYLANG_TOOLCHAIN_BASE_CANONICAL_VALUE_STORE_H_
